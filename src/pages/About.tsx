  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-[#232736] p-8 rounded-2xl border border-white/5 text-center">
          ...
          <p className="text-gray-400 text-sm">Tüm işlemleriniz İtemSatış güvencesi altındadır.</p>
        </div>
        <div className="bg-[#232736] p-8 rounded-2xl border border-white/5 text-center">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p className="text-gray-400 mb-6 leading-relaxed">
          İtemSatış, oyuncuların güvenle alışveriş yapabileceği, dijital varlıklarını nakite çevirebileceği bir platform olarak kurulmuştur. 
