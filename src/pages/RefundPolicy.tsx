      ...
      <div className="bg-[#232736] rounded-2xl border border-white/5 p-8 md:p-12">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              İade talebinizi "Destek Sistemi" üzerinden bir talep oluşturarak iletebilirsiniz. Talebiniz incelendikten sonra (genellikle 24 saat içinde) onaylanırsa, tutar İtemsatış bakiyenize anında iade edilir. Banka hesabınıza geri çekim talepleri bankanıza bağlı olarak 1-3 iş günü sürebilir.
            </p>
          </section>
        </div>
