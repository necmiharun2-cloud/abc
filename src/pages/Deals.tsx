...
export default function Deals() {
  ...
  const deals = [
    ...
    { id: 3, title: 'Steam 10 USD Cüzdan Kodu', oldPrice: '350 ₺', newPrice: '315 ₺', discount: '%10', image: 'https://picsum.photos/seed/s1/300/200' },
    { id: 4, title: 'LoL 1600 RP', oldPrice: '400 ₺', newPrice: '360 ₺', discount: '%10', image: 'https://picsum.photos/seed/l1/300/200' },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {deals.map((deal) => (
          <div key={deal.id} className="bg-[#232736] rounded-xl border border-white/5 overflow-hidden hover:border-[#5b68f6]/50 transition-colors group">
      ...
      <div className="bg-[#232736] rounded-xl border border-white/5 p-8 text-center">
