...
export default function Terms() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <div className="bg-[#232736] rounded-2xl border border-white/5 p-8 space-y-8">
        <section>
          ...
          <p className="text-gray-400 leading-relaxed">
            Bu sözleşme, İtemSatış platformunun kullanımına ilişkin şartları ve kuralları belirler. 
        ...
        <section>
          ...
          <p className="text-gray-400 leading-relaxed">
            ...
            Hesabın üçüncü şahıslar tarafından kullanılması durumunda doğacak zararlardan İtemSatış sorumlu tutulamaz.
          </p>
        </section>
        ...
        <div className="bg-[#1a1d27] p-6 rounded-xl border border-white/5">
          <p className="text-sm text-gray-500 italic">
            * İtemSatış, bu sözleşme maddelerinde dilediği zaman değişiklik yapma hakkını saklı tutar.
          </p>
        </div>
      </div>
    </div>
