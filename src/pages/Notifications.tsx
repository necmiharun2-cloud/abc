  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6">
      <div className="flex flex-col md:flex-row h-[600px] bg-[#232736] rounded-xl border border-white/5 overflow-hidden">
        <div className="w-full md:w-[350px] border-r border-white/5 overflow-y-auto bg-[#1a1d27]/50">
          {fetching ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
          ...
          {selected ? (
            <div className="relative z-10 max-w-2xl text-left w-full">
              ...
              <div className="bg-[#1a1d27] border border-white/5 rounded-xl p-5 text-gray-200 whitespace-pre-wrap">
                {selected.message}
              </div>
            </div>
          ) : (
