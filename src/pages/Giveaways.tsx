...
export default function Giveaways() {
  const giveaways = [
    { id: 1, title: '1000 Valorant Points', participants: 1240, endsIn: '2 gün', image: 'https://picsum.photos/seed/g1/400/200' },
    { id: 2, title: 'Discord Nitro (1 Aylık)', participants: 850, endsIn: '5 saat', image: 'https://picsum.photos/seed/g2/400/200' },
    { id: 3, title: 'Steam 100 TL Cüzdan Kodu', participants: 2100, endsIn: '12 saat', image: 'https://picsum.photos/seed/g3/400/200' },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {giveaways.map((g) => (
          <div key={g.id} className="bg-[#232736] rounded-xl border border-white/5 overflow-hidden hover:border-purple-500/50 transition-all group">
