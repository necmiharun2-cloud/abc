...
export default function DistanceSales() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <div className="bg-[#232736] rounded-2xl border border-white/5 p-8 md:p-12">
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          <section>
            ...
            <p>
              İşbu sözleşme, İtemsatış platformu üzerinden alışveriş yapan kullanıcı (ALICI) ile platformda ilan yayınlayan satıcı (SATICI) arasında, İtemsatış aracılığıyla akdedilmiştir.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Sözleşmeden doğan uyuşmazlıklarda Tüketici Hakem Heyetleri ve Tüketici Mahkemeleri yetkilidir. İtemsatış, alıcı ve satıcı arasında aracı kurum sıfatıyla uyuşmazlıkların çözümünde moderasyon desteği sağlar.
            </p>
          </section>
        </div>
