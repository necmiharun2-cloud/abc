    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4 h-[300px]">
        ...
        <div className="flex-[2] relative rounded-xl overflow-hidden bg-[#111] group cursor-pointer">
          <img src="https://picsum.photos/seed/robloxhero/800/400" alt="Roblox" className="absolute inset-0 w-full h-full object-cover opacity-50 group-hover:scale-105 transition-transform duration-700" />
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-12">
            ...
            <p className="text-gray-200 mb-8 max-w-md text-sm leading-relaxed">
              Roblox Robux Alışverişi İtemSatış'ta, Anında Yükle, Oyun Keyfini Katla!
            </p>
            <div>
        ...
        <div className="flex-1 flex gap-4">
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex-1 relative rounded-xl overflow-hidden group cursor-pointer">
              <img src={`https://picsum.photos/seed/roblox${i}/200/400`} alt="Roblox Card" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
