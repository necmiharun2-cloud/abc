  ...
  return (
    <div className="space-y-8">
      <div className="bg-[#232736] rounded-2xl p-10 border border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <img src="https://picsum.photos/seed/keys/300/200" className="w-64 h-40 object-cover rounded-xl shadow-2xl" alt="" />
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {keys.map((k) => (
          <div key={k.id} className="bg-[#232736] rounded-xl border border-white/5 p-5 hover:border-yellow-500/50 transition-all group">
