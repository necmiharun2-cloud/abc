...
export default function ProfileWarningModal() {
  ...
  useEffect(() => {
    ...
    const hasSeenWarning = localStorage.getItem('hasSeenProfileWarning');
    if (!hasSeenWarning) {
      setIsOpen(true);
    }
  }, []);
  ...
  const handleClose = () => {
    setIsOpen(false);
    localStorage.setItem('hasSeenProfileWarning', 'true');
  };
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-[#2b3142] rounded-xl max-w-[550px] w-full relative shadow-2xl border border-white/10 animate-in fade-in zoom-in duration-300">
        {/* Header */}
        ...
        <div className="p-8 flex flex-col items-center text-center">
          ...
          <p className="text-white text-lg font-semibold leading-relaxed mb-8 px-4">
            Kendini İtemSatış Yetkilisi veya Teslimat Görevlisi olarak tanıtanlara inanmayınız canlı desteğe bildiriniz.
          </p>
