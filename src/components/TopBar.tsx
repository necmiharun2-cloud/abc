      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between text-xs font-medium">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <a href="#" className="w-6 h-6 rounded bg-[#232736] flex items-center justify-center text-gray-400 hover:text-white hover:bg-[#5b68f6] transition-colors">
            ...
            <a href="#" className="w-6 h-6 rounded bg-[#232736] flex items-center justify-center text-gray-400 hover:text-white hover:bg-pink-600 transition-colors">
              <Instagram className="w-3.5 h-3.5" />
            </a>
            <a href="#" className="w-6 h-6 rounded bg-[#232736] flex items-center justify-center text-gray-400 hover:text-white hover:bg-red-600 transition-colors">
              <Youtube className="w-3.5 h-3.5" />
            </a>
            <a href="#" className="w-6 h-6 rounded bg-[#232736] flex items-center justify-center text-gray-400 hover:text-white hover:bg-black transition-colors">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-1 cursor-pointer text-gray-300 hover:text-white transition-colors group relative">
            Destek Merkezi
