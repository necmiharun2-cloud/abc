...
const news = [
  ...
  { id: 3, title: "İtemsatış Bahar İndirimleri Başladı! %50'ye Varan İndirimler", date: "05 Nisan 2026" },
...
export default function NewsTicker() {
  return (
    <div className="bg-[#232736] border-y border-white/5 py-3 relative flex items-center overflow-hidden">
      {/* Label */}
      ...
      {/* Gradient Masks */}
      <div className="absolute left-32 top-0 bottom-0 w-20 bg-gradient-to-r from-[#232736] to-transparent z-10"></div>
      <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-[#232736] to-transparent z-10"></div>
