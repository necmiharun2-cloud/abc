  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 h-[300px]">
      ...
      <div className="flex gap-4 w-full lg:w-auto">
        <div className="relative w-[180px] rounded-xl overflow-hidden group cursor-pointer">
      ...
      {/* Right Large Banner */}
      <div className="flex-1 relative rounded-xl overflow-hidden bg-[#3b82f6] group cursor-pointer">
        <div className="absolute inset-0 flex items-center justify-between px-12">
          ...
          <img src="https://picsum.photos/seed/h4/400/300" alt="Community" className="h-full object-contain object-right opacity-90 group-hover:scale-105 transition-transform duration-500" />
        </div>
      </div>
    </div>
  );
